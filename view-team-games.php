<html>
<head>
    <title>Mock NFL DBMS Site - Team Games</title>
...
<h3>Look at a Team's Games!</h3>
<h4>Enter the team you want to see below</h4>
<form action="view-team-games.php" method="post">
...
if (isset($_POST['submit']))
{
    ...
    $command = 'python3 view-team-games.py ' . $team;
